<?php 
	...
	$per_page = 20;
		...
		if($cat->num_rows) {
			...
			$result = "<p style='color:blue; padding: 10px; background: #ffeeee;'>No records available in the database yet</p>";
        ...
        <nav class="navbar navbar-default navbar-fixed" style="background: blue;">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#" style="color: white;">FOOD COLLECTION</a>
                </div>
